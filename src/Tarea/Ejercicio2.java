 ...
 * N de 5 cifras y muestre sus cifras desde el final.
 *************************************************/
package Tarea;
	...
	//Declaracion de atributos 
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == btnEnviar );{
				...
				String cifras = "";
				for(int i = 4; i >= 0; i--) {
					cifras += Integer.toString(x).substring(i, i+1) + " ";
				}

				System.out.println("Cifras: " + cifras);
				JOptionPane.showMessageDialog(null, "Las cifras del número ingresado son: " + cifras, "Resultado", JOptionPane.INFORMATION_MESSAGE);
			}
		}
